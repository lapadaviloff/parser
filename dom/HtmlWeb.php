...
include_once  'Proxy/getProxy.php';
...
class HtmlWeb {
	...
	private function load_curl($url)
	{
		...
		$Useragent= "Mozilla/5.0 (Windows NT 6.3; W…) Gecko/20100101 Firefox/57.0";//my
		curl_setopt($ch, CURLOPT_USERAGENT, $UserAgent);//my
		
		$sProxyIp=getProxy();
		echo $sProxyIp.PHP_EOL;
		//$iProxyPort="";
		//$sProxyType='CURLPROXY_HTTP';
...
//		curl_setopt($rCh, CURLOPT_TIMEOUT, 10);
//		$useragent= "Mozilla/5.0 (Windows NT 6.3; W…) Gecko/20100101 Firefox/57.0";//my
//		curl_setopt($ch, CURLOPT_USERAGENT, $sUserAgent);//my
//		
//		$sProxyIp='79.134.7.134:49230';
//		$iProxyPort="";
//		$sProxyType='CURLPROXY_HTTP';
//		curl_setopt($ch, CURLOPT_PROXY, $sProxyIp);
  //      curl_setopt($ch, CURLOPT_PROXYTYPE, CURLPROXY_SOCKS4);
